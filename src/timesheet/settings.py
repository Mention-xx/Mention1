...
### The default settings use PostgreSQL with ident authentication
DATABASES = {
    'default': {
...
MEDIA_ROOT = '%s/assets/media/' % os.path.abspath(os.path.expanduser('~/'))
...
SECRET_KEY = '%2p0#7kg_ygby2m(g)7jkl=3d1)f@ffyw^omh2%tv0dsro*l3q'
